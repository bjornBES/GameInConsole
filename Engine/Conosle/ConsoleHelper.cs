...
namespace GameInConsoleEngine.Engine
{
    ...
    class NativeMethods
    {
        ...
        public struct ExtendedCharInfo
        {
            [FieldOffset(0)] public char UnicodeChar;
            [FieldOffset(0)] public byte AsciiChar;
            [FieldOffset(2)] public byte ForegroundRed;       // Foreground Red (0-255)
            [FieldOffset(3)] public byte ForegroundGreen;     // Foreground Green (0-255)
            [FieldOffset(4)] public byte ForegroundBlue;      // Foreground Blue (0-255)
            [FieldOffset(5)] public byte BackgroundRed;       // Background Red (0-255)
            [FieldOffset(6)] public byte BackgroundGreen;     // Background Green (0-255)
            [FieldOffset(7)] public byte BackgroundBlue;      // Background Blue (0-255)

            public ExtendedCharInfo(char character, Color foreGround, Color backGround)
            {
                UnicodeChar = character;
                ForegroundRed = (byte)foreGround.R;
                ForegroundGreen = (byte)foreGround.G;
                ForegroundBlue = (byte)foreGround.B;
                BackgroundRed = (byte)backGround.R;
                BackgroundGreen = (byte)backGround.G;
                BackgroundBlue = (byte)backGround.B;
            }
        }
